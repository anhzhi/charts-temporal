...
export const SELECT_PARENT_DASHBOARD = 'SELECT_PARENT_DASHBOARD'
export const SELECTED_PARENT_DASHBOARD_IS_GROUPED = 'SELECTED_PARENT_DASHBOARD_IS_GROUPED'
...
export const SELECT_DASHBOARD_TAG_SUBDIVISION = 'SELECT_DASHBOARD_TAG_SUBDIVISION'
export const SET_GRAPH_HEIGHT = 'SET_GRAPH_HEIGHT'
export const SELECT_MAIN_FILTER = 'SELECT_MAIN_FILTER'